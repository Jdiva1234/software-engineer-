...
public class PoorCode {
     ...
     *
     */
    public static void greetings(String title, String firstName, String secondName){
        System.out.println("Hello, " + title + " " + firstName + " " + secondName);
    }
    ...
    /*
     * Method the sumOfArray
     */
    public static void sumOfArray(double[] arr) {
        double sum = 0.0;
        for (int i = 0; i < arr.length; i++)
            sum += arr[i];
    ...
    public static void variance(double[] arr) {
        double variance = 0.0;
    ...
    public static double[] sortArrays(double[] arr) {
    ...
    public static boolean numberSorting(int n) {
        if(n <= 1)
            return false;
        for(int i = 2; i < n; i++)
            if(n % i == 0)
